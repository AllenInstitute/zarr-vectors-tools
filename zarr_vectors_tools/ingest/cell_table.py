...
It differs from :mod:`zarr_vectors_tools.ingest.csv_points` in exactly the
...
- **A header.** Column labels and categories are recorded so
  :func:`~zarr_vectors_tools.export.h5ad.export_h5ad` can reconstitute the
  table.

Ingest the coordinate table once with :func:`ingest_table`, then stage in
each remaining file with :func:`attach_table` or
:func:`~zarr_vectors_tools.ingest.h5ad.attach_h5ad`.
"""
